...
\section{Delegation}
Delegation can be seen as forwarding \java{this.f(...)} calls to \java{other.f(...)} \textbf{on behalf of this.} That is, call \java{other.f(...)} but have the self reference within that call set to my self reference.
\newline
